<%-- 
    Document   : StationNameToCode
    Created on : Apr 18, 2018, 10:18:02 PM
    Author     : Viney Kumar
--%>
        ...
        <script>
          function sname()
          {
             ...
             var xmlhttp = new XMLHttpRequest();
                ...
                xmlhttp.open("GET", "./StationNameToCode?sn=" + sn, true);
                xmlhttp.send();
...
//                    console.log(ans);
    ...
    <body>
        <div class="container">
            <div class="jumbotron"><h1  style="color: palegreen">Station Name To Code</h1></div>
            <div class="row">
                <div class="col-sm-6" id="d1">
                    <form class="form-horizontal">
                        <div class="form-group">
                            <label for="sn" style="margin-left:20px" class="in">Enter Station Name</label> 

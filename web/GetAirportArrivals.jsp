    ...
    <head>
        ...
        <script>
               ...
               function detial()
            {
                ...
                var  hd= document.getElementById("hd").value.trim();
                var  nh= document.getElementById("nh").value.trim();
                if (cc == "" || dt == "" || nh == "")
                {
                ...
                xmlhttp.open("GET", "./GetAirportArrivals?cc=" + cc + "&dt=" + dt + "&hd=" + hd+"&nh=" + nh, true);
                xmlhttp.send();
            }

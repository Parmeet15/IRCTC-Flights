<%-- 
    Document   : GetScheduleArrival
    Created on : Apr 27, 2018, 3:20:24 AM
    Author     : Viney Kumar
--%>
...
//                        console.log(resjson);
                ...
                xmlhttp.open("GET", "./GetScheduleArrival?cc=" + cc + "&dt=" + dt + "&hd=" + hd, true);
                xmlhttp.send();
            }
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="jumbotron" id="hed">
                    <h2 class=" text-success"><strong> SCHEDULE OF ARRIVAL FLIGHTS   <i class="material-icons" style="font-size:55px;color:green">flight_land</i></strong></h2>
                </div>
                <div class="col-sm-4">
